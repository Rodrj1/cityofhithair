export const dialogMarion = {
  ...
  evil: "This evil called himself Thune. Kimvaema's greatest bluff was that he was Maidar, Lord of the Valryn. Excuses for their defeat. Thune was powerful to such an extent that his evil still lingers in the great dungeons beneath. The extension of what he built is unknown, his creations are all around the world. From frozen and forgotten Atro, to Azmay and beyond the Neptun's Sea. But he was not Maidar. Thune made unfathomable dungeons, Maidar spoke the moon into existence.",
  tamoe:
  ...
  merchant:
    "His name is Sagrob. Odd fellow. I can't quite tell wheter he is sane or not. He would be just another merchant ranting about the most common of things with that drunken voice of his, if he would not then speak normally in a whim. Better than normal actually, almost unsettling the way he sometimes can speak. He might have been a capable warrior once, or something related to that. No merchant can go to those crypts, stole items from dead bodies and come back alive and unscathered. In any case, we are already acquainted for some long thirty and so years. As I said before, an odd one, but harmless",
};
...
export const dialogNicolai = {
  ...
  ofMe: 'You will be my phylactery. To attain immortality, humans had used artifacts to trap their own spirit into it. This process I deemed impossible for a dragon, as no object may contain our spirit. In exchange for the knowledge within this dungeons, my master has reshapen the fabrics of reality, making an exception for me. A living phylactery of a powerful spirit. This room shall be sealed, and you will be trapped and forgotten, here to wrestle these chains for all eternity, and with only your lament as companion.',
  inTime:
    'Perhaps. But your kin will have to vanquish me every single time. I have but to win once.',
  join: 'It all will end fast.',
};

export const notesInfo = {
  ofKoetria:
    'Koetria, the three-legged spirit was the third child of Thune. In her making he put his sorcery on her, and in guile she walked. \n\nOur greatest hero, Tamoé, became bound by her spell and never knew. Of the spirits forged by Thune beneath the earth, Koetria followed him the most, and called him father.\n\nBeware if you dare go down, for her evil taint lingers, and her servants, the lifeless husks of once honorable men, dwell still.',
  journalPartI:
    "My master confessed me that the knowledge beneath Hithair is needed to 'end a story' of his. I am to travel in the guise of men for he fears I might destroy that which he seeks. I know the lackeys of Thune still roam the dungeons, they will keep anyone from following me.",
  journalPartII:
